...
describe("Controller functions", () => {
  ...
  describe("login", () => {
    it("should login and return a token", async () => {
      ...
      bcrypt.compare = jest
        .fn()
        .mockImplementation((password, hashedPassword) => { return Promise.resolve(true) });
  ...
  describe("update", () => {
    it("should update a profile", async () => {
      const profileId = 1;
      const requestData = { name: "The Last Airbender" };
      const mockedProfile = {
        id: profileId,
        name: "Aang",
        email: "aang@avatar.com",
