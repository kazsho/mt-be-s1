...
describe("VoiceNotes class", () => {
  ...
  describe("update method", () => {
    it("should update a voice note", async () => {
      const voiceNote = new VoiceNotes({
        audio_id: 1,
        conversation_id: 1,
        audio_data: "mocked-audio-data",
      });
      ...
      const mockResponse = { rows: [{
            audio_id: 1,
            conversation_id: 1,
            audio_data: "new-mocked-audio-data",
          }]};
      db.query.mockResolvedValue(mockResponse);
  ...
  describe("destroy method", () => {
    it("should delete a voice note", async () => {
      ...
      const mockResponse = {
        rows: [{ audio_id: 1, conversation_id: 1, audio_data: "mocked-audio-data" }]};
      db.query.mockResolvedValue(mockResponse);
